    ...
    if usr_cmdall1.startswith("/start zautekm"):
            ...
            for files in filedetails:
                ...
                buttons = [
                    [
                        ...
                        InlineKeyboardButton('More Bots', url='https://t.me/Being_D_evil')
                    ],
                    [
                        InlineKeyboardButton('👨‍💻 Developer @Being_D_evil 📢', url=f'{DEV_CHANNEL}')
                    ]
                    ]
        ...
        await message.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                ...
                InlineKeyboardButton("🤖 Want a Bot 🤖", url="https://t.me/Being_D_evil")
                ]]
            )
        )
        StopPropagation
...
async def bot_info(bot, message):
    buttons = [
        [
            ...
            InlineKeyboardButton('Channel 📢', url=f'https://t.me/HDFilmz4U')
        ]
        ]
